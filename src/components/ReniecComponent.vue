  ...
  setup() {
    ...
    const fetchDniData = async () => {
      try {
        ...
        error.value = 'Error al consultar RENIEC';
      }
    }
          ...
          <div>
            ...
            <div class="mt-5">
              <table class="min-w-full bg-white border">
                ...
                <tbody>
                <tr v-if="dataFromReniec">
                  <td class="border px-4 py-2">{{ dataFromReniec.nombres }}</td>
                  <td class="border px-4 py-2">{{ dataFromReniec.apellidoPaterno }}</td>
                  <td class="border px-4 py-2">{{ dataFromReniec.apellidoMaterno }}</td>
                </tr>
                </tbody>
              </table>
            </div>
